classdef ex04_two_genes_expression
	...
	methods
		function obj = ex04_two_genes_expression()
			%% Constructor of ex04_two_genes_expression.
		...
		function dx = ode(~,t,x,p)
			...
			% der(B__mRNA)
			dx(3,1) =  + (p.B__k_m) - (p.B__d_m.*B__mRNA) + (p.B__k_p.*B__mRNA) - (p.B__k_p.*B__mRNA);
